...
public interface FlightRepository extends JpaRepository<Flight, Long> {
    List<Flight> findByDepartureDateEqualsAndDepartureAirportEqualsAndArrivalAirportEquals(Date departureDate, Airport departureAirport, Airport arrivalAirport);
